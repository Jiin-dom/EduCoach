...
import { Search, Brain, ArrowUpDown, X, Sparkles, MessageCircle, FileText, Loader2, ChevronRight } from 'lucide-react'
                ...
                {filtered.map((concept) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="pointer-events-none absolute right-4 top-4 flex items-center gap-1 rounded-full border border-border/60 bg-background/70 px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground opacity-0 shadow-sm backdrop-blur transition-[opacity,transform] duration-200 group-hover:opacity-100 group-hover:translate-x-0 translate-x-1">
