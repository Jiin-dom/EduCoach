              ...
              <>
                <div className="space-y-4">
                  ...
                  {displayedMasterySummary.map((item) => (
                    <div key={item.documentId} className="space-y-2 rounded-lg border p-4">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="text-right">
                          <p className="text-lg font-bold">{item.averageMastery}%</p>
                          <p className="text-xs text-muted-foreground">Average mastery</p>
                        </div>
                      </div>
                      <Progress value={item.averageMastery} className="h-2" />
                      <div className="flex flex-wrap gap-3 text-xs text-muted-foreground">
                        <span className="text-green-700">{item.masteredCount} mastered</span>
                        <span className="text-yellow-700">{item.developingCount} developing</span>
                        <span className="text-red-700">{item.needsReviewCount} needs review</span>
                      </div>
                    </div>
                  ))}
                </div>
